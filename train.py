...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr_g', type=float, default=1e-4*2)
    parser.add_argument('--lr_g_decay', type=float, default=0.999)
    parser.add_argument('--lr_d', type=float, default=1e-4*2)
    parser.add_argument('--lr_d_decay', type=float, default=0.999)
